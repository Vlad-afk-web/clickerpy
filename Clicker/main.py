...
class MainApp(App): 
    storage = None
    LEVELS = ['Heavy', 'Soldier', 'Medic']

    PLANETS = {
        'Heavy': {"source": 'assets/images/2.png', 'hp': 10, 'size': ('200dp', '200dp')},
        'Soldier': {"source": 'assets/images/3.png', 'hp': 10,'size': ('200dp', '200dp')},
        'Medic': {"source": 'assets/images/4.png', 'hp': 10,'size': ('200dp', '200dp')},
    }
